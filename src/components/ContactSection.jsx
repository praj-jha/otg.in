...
const contactInfo = [
    ...
    },
    {
        ...
        title: 'Call Us',
        details: '+91 8851972135'
    },
    {
        id: 3,
        icon: <Mail className="h-6 w-6" />,
        title: 'Email Us',
        details: 'contact@onetrilliongroup.in'
    },
    {
        id: 4,
            ...
            <div className="mx-auto max-w-7xl px-6">
                <AnimatedGroup
                    ...
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-bold tracking-tight md:text-5xl text-white">Get in Touch</h2>
                        <p className="mt-4 text-xl text-white/75 max-w-3xl mx-auto">
                            Have questions or ready to start a project? Reach out to our team for a consultation.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="flex gap-4 mt-8">
                                <a href="#" className="p-2 bg-orange-500/20 rounded-full text-orange-500 hover:bg-orange-500/30 transition-colors">
                        ...
                        <div className="lg:col-span-3 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-8">
                            ...
                            <form className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            id="name"
                                            className="w-full p-3 rounded-md border border-white/20 bg-white/5 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-orange-500"
                                ...
                                <Button size="lg" className="w-full bg-orange-500 text-white hover:bg-orange-600">Send Message</Button>
                            </form>
                        </div>
                    </div>
                </AnimatedGroup>
